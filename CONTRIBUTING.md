...
# Clone your fork
git clone git@github.com:<your-username>/prismic-ts-codegen.git
...
## `prismic-ts-codegen` in Prismic's Open-Source Ecosystem
...
[repo-issue]: https://github.com/prismicio/prismic-ts-codegen/issues/new/choose
